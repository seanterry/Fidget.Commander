...
{
    public class CommandDecorator_TCommand_Tests
    {
        class TestCommand : ICommand { }
        class Decorator : CommandDecorator<TestCommand>
        {
        ...
        ICommandDecorator<TestCommand> instance => new Decorator();

        public class Execute : CommandDecorator_TCommand_Tests
        {
            TestCommand command = new TestCommand();
            CancellationToken cancellationToken = CancellationToken.None;
            CommandDelegate<TestCommand, Unit> continuation = ( cmd, cancellationToken ) => throw new NotImplementedException();
